    ...
    return (
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 text-center">
          <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-[#6a9772]"></div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center py-12 bg-red-50 rounded-2xl border border-red-200 max-w-2xl mx-auto">
            ...
            <h3 className="text-2xl font-bold text-gray-700 mb-2">Failed to Load Reviews</h3>
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#1a2e24] mb-4">
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-[#1a2e24] mb-1">
                    {review.touristName}
                  </h3>
        ...
        {hasMore && (
          ...
          >
            <button
              ...
              className="px-8 py-3 bg-[#6a9772] text-white rounded-lg hover:bg-[#5a8662] transition-colors font-semibold shadow-md hover:shadow-lg"
            >
